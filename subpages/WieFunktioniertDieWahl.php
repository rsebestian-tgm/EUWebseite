...
<head>
  ...
  <title>EU-Wahlen | Wie funktioniert die Wahl?</title>
    ...
    <div class="row">
      ...
      <!-- Post Content Column -->
        <div id = "content" class="col-lg-8">
            <?php
                include 'contentfiles/WieFunktioniertDieWahl/Content.php';
            ?>
      </div>
      ...
      <!-- Sidebar Widgets Column -->
        ...
        <!-- <div id="sidecontent" class="card my-4">
            <?php
                include 'contentfiles/WieFunktioniertDieWahl/SideContent.php';
            ?>
      </div> -->
    </div>
  </div>
