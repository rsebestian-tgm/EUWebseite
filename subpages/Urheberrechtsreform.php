...
<head>
  ...
  <title>EU-Urheberrechtsreform: Artikel 11 und 13</title>
    ...
    <div class="row">
      ...
      <!-- Post Content Column -->
        <div id = "content" class="col-lg-8">
            <?php
                include 'contentfiles/Urheberrechtsreform/Content.php';
            ?>
      </div>
      ...
      <!-- Sidebar Widgets Column -->
        ...
        <!-- <div id="sidecontent" class="card my-4">
            <?php
                include 'contentfiles/Urheberrechtsreform/SideContent.php';
            ?>
      </div> -->
    </div>
  </div>
