...
<head>
  ...
  <title>EU-Wahlen | Ist eine EU-Armee gut?</title>
    ...
    <div class="row">
      ...
      <!-- Post Content Column -->
        <div id = "content" class="col-lg-8">
            <?php
                include 'contentfiles/StefanHiermannMeinungsrede/Content.php';
            ?>
      </div>
      ...
      <!-- Sidebar Widgets Column -->
        ...
        <!-- <div id="sidecontent" class="card my-4">
            <?php
                include 'contentfiles/StefanHiermannMeinungsrede/SideContent.php';
            ?>
      </div> -->
    </div>
  </div>
